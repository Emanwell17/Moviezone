...
export const getSubtitleVttUrl = (slug) =>
  `${API}/api/subtitle-proxy?slug=${encodeURIComponent(slug)}`;

export const getSubtitleSrtUrl = (slug) =>
  `${API}/api/subtitle-proxy?slug=${encodeURIComponent(slug)}&format=srt`;
